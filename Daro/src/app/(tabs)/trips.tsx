...
// TODO: end-to-end type safety with trpc?
    ...
    <Link asChild href={`/detail/${item.listingId}`}>
      <TouchableOpacity activeOpacity={0.8} style={cardStyles.card}>
        ...
        <View style={cardStyles.cardContent}>
          ...
          <Text style={cardStyles.cardDesc}>{t('trips.host', { name: item.hostName })}</Text>
        ...
        ListEmptyComponent={
          isLogin ? (
            ...
            <View style={styles.emptyWithoutLogin}>
              <Text style={styles.emptyTitleWithoutLogin}>{t('trips.noTripsYet')}</Text>
              <Text style={styles.emptyDescWithoutLogin}>{t('trips.noTripsDesc')}</Text>
              <LoginButton />
            </View>
          )
        }
